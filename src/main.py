...
def preprocess(train_df, test_df):
    ...
    high_corr_cols = [
        ...
        "census2_　総数７５歳以上",
        "census2_　親族世帯",
        "census2_　１８歳未満世帯員のいる一般世帯総数",
        "census2_　６歳未満世帯員のいる一般世帯総数",
        "census2_　６５歳以上世帯員のいる一般世帯総数",
        "census2_一般世帯人員",
        "census2_一般世帯総数",
        "census2_主世帯数",
        "census2_住宅に住む一般世帯",
        "census2_分類不能の世帯",
        "census2_女の総数、年齢「不詳」含む",
        "census2_男の総数、年齢「不詳」含む",
        "census2_総数_x",
        "census2_総数、年齢「不詳」含む",
        "census2_雇用者（役員を含む）",
        "census2_非農林漁業就業者世帯",
        ...
        "econ_census_2_size",
        "econ_census_3_size",
        "econcensus_女Ａ_Ｒ全産業（Ｓ公務を除く）",
        "econcensus_従業者規模_総数",
        "econcensus_従業者規模_総数_1",
        "econcensus_従業者規模_１_４人_1",
        "econcensus_従業者規模_１０_１９人",
        "econcensus_従業者規模_１０_１９人_1",
        "econcensus_従業者規模_２０_２９人_1",
        "econcensus_従業者規模_３０人以上_1",
        "econcensus_従業者規模_５_９人",
        "econcensus_従業者規模_５_９人_1",
        "econcensus_男Ａ_Ｒ全産業（Ｓ公務を除く）",
        "econcensus_経営組織_うち法人",
        "econcensus_経営組織_うち法人_1",
        "econcensus_経営組織_会社",
        "econcensus_経営組織_会社_1",
        "econcensus_経営組織_総数",
        "econcensus_経営組織_総数_1",
        "price_前年用途",
        "price_前年連番",
        "price_経度",
        "price_緯度",
